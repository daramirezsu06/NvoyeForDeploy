...
type Props = {
  handleCloseCreateCustomTask: () => void;
...
export default function CreateCustomTaskForm({
  handleCloseCreateCustomTask,
  onAddTask,
  handleCloseNewTask,
}: Props) {
  ...
  const handleCreateTask = () => {
    ...
    const newTask: IBackendTasks = {
      ...
      taskStatus: {
        name: 'Pending', // Ajusta según tu lógica
    ...
    handleCloseCreateCustomTask(); // Cierra el modal
    handleCloseNewTask();
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <IconButton onClick={handleCloseCreateCustomTask}>
          <Icon>
            <Close />
          </Icon>
        </IconButton>
      ...
      >
        <Button
          ...
          onClick={handleCloseCreateCustomTask}
        >
          Cancel
        </Button>
